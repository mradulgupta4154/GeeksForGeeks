...
<strong>Output: </strong>10<br><strong>Explanation: </strong></span><span style="font-size: 18px;">The maximum element in the array is 19. Since we can only increment elements, all elements must be made equal to 19.
...
Total operations = 5 + 4 + 0 + 1 = 10.</span></pre>
